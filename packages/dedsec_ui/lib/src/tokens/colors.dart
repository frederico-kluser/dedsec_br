...
/// Brand palette. Mirrors the JS `COL` object from the React prototype.
class DedsecColors {
  const DedsecColors._();
  ...
  // Extra: light blue used in some chips (`#7fc8ff`).
  static const skyBlue = Color(0xFF7FC8FF);
}
