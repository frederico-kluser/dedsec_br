...
const initialTopics = <ForumTopic>[
  ForumTopic(
    id: 't1', live: true, tag: 'TRANSPORTE', scope: TopicScope.mun,
    title: 'Linha 17-Ouro: como cobrar o TCE-SP?',
    author: 'Cidadão_SP_4a7b', replies: 87, age: '12 min', hot: true, newReplies: 5,
  ...
  ForumTopic(
    id: 't2', tag: 'ORÇAMENTO', scope: TopicScope.mun,
    title: 'Audiência pública pulada — vamos ao MP?',
    author: 'Cidadão_SP_91cd', replies: 34, age: '1h', newReplies: 2,
...
const initialReplies = <ForumReply>[
  ForumReply(
    id: 'r1', who: 'Cidadão_SP_91cd', seed: 'Cidadão_SP_91cd', age: '8 min',
    body: 'Já mandei pra ouvidoria do TCE-SP. Protocolo é OUVI-2026-001234. Quem quiser comentar lá, link no perfil oficial.',
    reacts: {'⚡': 23, '🔥': 12},
  ),
  ForumReply(
    id: 'r2', who: 'Cidadão_SP_bb22', seed: 'Cidadão_SP_bb22', age: '6 min',
    body: 'Boa! Importante lembrar que o prazo de resposta da Ouvidoria do TCE é 20 dias úteis pela Lei 12.527. Vale acompanhar.',
    reacts: {'👍': 18},
  ),
  ForumReply(
    id: 'r3', who: 'Cidadão_SP_d013', seed: 'Cidadão_SP_d013', age: '3 min',
    body: 'Tem alguém que entende de licitação e pode olhar os aditivos do contrato? Tá tudo público no D.O. mas é denso.',
    reacts: {'🤔': 9},
  ),
];
